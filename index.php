        ...
        <div class="grid_5 grid_7">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <ul id="myTab" class="nav nav-pills nav-justified" role="tablist">
                    ...
                    <li role="presentation" class="active"><a style="color: black;" href="#kuetar" id="kuetar-tab" role="tab" data-toggle="tab" aria-controls="kuetar" aria-expanded="true">Variasi Coklat</a></li>
                    <li role="presentation"><a style="color: black;" href="#kuekering" role="tab" id="kuekering-tab" data-toggle="tab" aria-controls="kuekering" s>Variasi Buah</a></li>
                    <li role="presentation"><a style="color: black;" href="#kuebasah" role="tab" id="kuebasah-tab" data-toggle="tab" aria-controls="kuebasah">Variasi Lainnya</a></li>
                </ul>
                       
<div id="myTabContent" class="tab-content">
     <div role="tabpanel" class="tab-pane fade in active" id="kuetar" aria-labelledby="kuetar-tab">
        <div class="agile-tp">
            <h2>Variasi Coklat</h2>
             <br>
                                </div>
