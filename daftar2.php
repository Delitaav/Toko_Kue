                                        ...
                                        if (isset($_POST['register']))
                                        {
                                            ...
                                            else 
                                            {
                                              ...
                                              $koneksi->query("INSERT INTO pelanggan
                                                    (email_pelanggan,nama_pelanggan,password_pelanggan,telphone_pelanggan,nama_kota,alamat_pelanggan,jabatan) VALUES ('$email','$nama','$password','$telp','$kota','$alamat','$jabatan')");
